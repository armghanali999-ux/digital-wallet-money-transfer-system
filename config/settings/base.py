...
AUTHENTICATION_BACKENDS = ["accounts.backends.ActiveStatusBackend"]
LOGIN_URL = "login"
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "common.api.exceptions.domain_exception_handler",
}
...
LOGGING = {
    ...
    "loggers": {
        ...
        "wallet_app": {"handlers": ["console"], "level": LOG_LEVEL, "propagate": False},
    },
}
